...
<head>							
	...
	<meta charset="utf-8">
	<title>Contact Us - Omega Dezine</title>
...
<body>
	...
	<section id="section4" style="background-color:#c9c9c9;; border-radius: 10px;">
		<h1>Contact Us</h1>
		<div id="contactUs" class="display-item" style="text-align: center;">
			<div id="footer-details" style="text-align:left;">
				<div id="footer-discription" class="col-sm-12">
					<p style="color:black;">Omega Dezine. We are the leading company in the areas of Graphic. Embroidery and Web Development Services provider serving the promotion products. Retail, quick print and may other industries. The company was started in 2009 with small projects and after only some years out growth has made us the strongest company in the compititive market.</p>
				</div>
				<div id="get-in-touch" class="col-sm-12" style="text-align: left;">
					<div class="text">
						<div class="subtext col-sm-3">
							<p style="color:black;"><i class="fa fa-map-marker" aria-hidden="true"></i> 14455 N. 28th Way Phoenix, AZ</p>
						</div>
						<div class="subtext col-sm-3">
							<p style="color:black;"><i class="fa fa-phone" aria-hidden="true"></i> Australia<br>&nbsp;&nbsp;&nbsp;+61 (03) 90169357</p>
						</div>
						<div class="subtext col-sm-3">
							<p style="color:black;"><i class="fa fa-phone" aria-hidden="true"></i> USA<br>&nbsp;&nbsp;&nbsp;229-638-1577 | 678-367-3758</p>
						</div>
						<div class="subtext col-sm-2">
							<p style="color:black;"><i class="fa fa-envelope-o" aria-hidden="true"></i> info@omegadezine.com</p>
							<br>
						</div>
					</div>
				</div>
		...
		<div class="contact col-sm-12" style="text-align: center;">
			<div class="contact-form col-sm-6" style="display: inline-block;vertical-align: top;color:black;">
				<form action="">
					<input type="text" name="name" placeholder="Name" required>
					<input type="email" name="email" placeholder="Email" required>
					<textarea rows="5" placeholder="Your valuable comments"></textarea>
					<button>Connect Me</button>
				</form>
			</div>
			<div class="col-sm-5" style="display: inline-block;">
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d236213.5020536378!2d73.03300029303715!3d22.32204248029837!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395fc8ab91a3ddab%3A0xac39d3bfe1473fb8!2sVadodara%2C%20Gujarat!5e0!3m2!1sen!2sin!4v1623536947843!5m2!1sen!2sin" width="100%" height="380" style="border:0;" allowfullscreen="" loading="lazy" class=""></iframe>
			</div>
		</div>

		<div style="height:15px;"></div><br><br><br>
