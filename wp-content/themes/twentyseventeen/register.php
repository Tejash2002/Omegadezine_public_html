...
<head>							
	...
	<meta charset="utf-8">
	<title>Register - Omega Dezine</title>
...
<body>
	...
	<!-- Services Start -->
	<section id="section4" style="background-color: rgba(10, 10, 10, 0.7); border-radius: 10px;">
		<h1>Register</h1>
		<div class="display-item" style="text-align: center;">
		 
     
    <?php $contact='[contact-form-7 id="35" title="register"]'?>
